...
Private Sub DefineServiceClaimRanges()
  With Worksheets("Parameters")
    ...
    'Create ranges
    ThisWorkbook.Names.Add "TORs", Range(P_TORs & 2, Range(P_TORs & 2).End(xlDown))
    ThisWorkbook.Names.Add "TORTasks", Range(P_TORs2 & 2, Range(P_TORs2_TASKS & 2).End(xlDown))
    ThisWorkbook.Names.Add "Projects", Range(P_PROJECTS & 2, Range(P_PROJECTS & 2).End(xlDown))
    ThisWorkbook.Names.Add "ProjectTasks", Range(P_PROJECTS2 & 2, Range(P_PROJECTS2_TASKS & 2).End(xlDown))
    ThisWorkbook.Names.Add "TaskNodeIDs", Range(P_TASKS_IDs_1 & 2, Range(P_TASKS_IDs_2 & 2).End(xlDown))
    ThisWorkbook.Names.Add "NodeIDGrants", Range(P_ID_GRANTS_1 & 2, Range(P_ID_GRANTS_2 & 2).End(xlDown))
    ThisWorkbook.Names.Add "GrantIDs", Range(P_GRANT_IDs_1 & 2, Range(P_GRANT_IDs_2 & 2).End(xlDown))
    ThisWorkbook.Names.Add "Currencies", Range(P_CURRENCIES & 2, Range(P_CURRENCIES & 2).End(xlDown))
    ThisWorkbook.Names.Add "ExpenseCategories", Range(P_EXPENSECATEGORIES & 2, Range(P_EXPENSECATEGORIES & 2).End(xlDown))
  End With
End Sub
